...
const navigation: NavigationItem[] = [
    ...
    { name: 'Our Team', href: '#ourteam-section', current: false },
    { name: 'FAQ', href: '#faq-section', current: false },
    { name: 'Our Classes', href: '#our-classes-section', current: false },
                    ...
                    <div className="relative flex h-12 sm:h-20 items-center">
                        <div className="flex flex-1 items-center sm:justify-between">
                            ...
                            <div className="flex flex-shrink-0 items-center border-right">
                                ...
                                {/* <Image src="/images/banner/Beatnation Logo.png" width={120} height={100} alt="logo-navbar-image" className="absolute -left-20" /> */}
                            </div>
